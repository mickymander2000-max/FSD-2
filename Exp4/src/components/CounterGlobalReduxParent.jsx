    ...
    return (
        <div style={{
            ...
            <h3 style={{
                ...
                Redux Store #{props.cno}: <span style={{ fontSize: '2.5em' }}>{count}</span>
            </h3>

            <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
                <button onClick={() => dispatch({ type: "INCREMENT" })} style={{
                    margin: "8px",
                    padding: "12px 28px",
                    ...
                    onMouseEnter={(e) => {
                        ...
                        e.target.style.background = 'linear-gradient(135deg, rgba(251, 146, 60, 0.3) 0%, rgba(249, 115, 22, 0.3) 100%)';
                    }}
                    onMouseLeave={(e) => {
                        e.target.style.transform = 'translateY(0)';
                        e.target.style.boxShadow = '0 8px 24px rgba(251, 146, 60, 0.2)';
                        e.target.style.background = 'linear-gradient(135deg, rgba(251, 146, 60, 0.2) 0%, rgba(249, 115, 22, 0.2) 100%)';
                    }}>
                    ➕ INCREASE
                </button>

                <button onClick={() => dispatch({ type: "DECREMENT" })} style={{
                    margin: "8px",
                    padding: "12px 28px",
                    background: 'linear-gradient(135deg, rgba(251, 146, 60, 0.2) 0%, rgba(249, 115, 22, 0.2) 100%)',
                    color: "#fed7aa",
