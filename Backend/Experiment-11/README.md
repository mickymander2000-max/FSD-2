...
def get_account_details(user_id):
    ...
    try:
        response = requests.get(
            f"https://23bis70119-experiment-11-customer.onrender.com/orders/user/{user_id}",
            timeout=3
        )
...
- Customer Service: https://23bis70119-experiment-11-customer.onrender.com
- Order Service: https://23bis70119-experiment-11-order.onrender.com
